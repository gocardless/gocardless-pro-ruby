...
describe GoCardlessPro::Services::VerificationDetailsService do
  let(:client) do
  ...
  describe '#list' do
    describe 'with no filters' do
      ...
      it 'wraps each item in the resource class' do
        expect(get_list_response.records.map { |x| x.class }.uniq.first).to eq(GoCardlessPro::Resources::VerificationDetail)
  ...
  describe '#all' do
    ...
    describe 'retry behaviour' do
      ...
      it 'retries timeouts' do
        first_response_stub = stub_request(:get, %r{.*api.gocardless.com/verification_details$}).to_return(
          body: {
            'verification_details' => [{
        ...
        client.verification_details.all.to_a
