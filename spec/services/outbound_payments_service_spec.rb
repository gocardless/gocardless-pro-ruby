...
describe GoCardlessPro::Services::OutboundPaymentsService do
  let(:client) do
  ...
  describe '#all' do
    ...
    describe 'retry behaviour' do
      ...
      it 'retries timeouts' do
        first_response_stub = stub_request(:get, %r{.*api.gocardless.com/outbound_payments$}).to_return(
          body: {
            'outbound_payments' => [{
        ...
        client.outbound_payments.all.to_a
