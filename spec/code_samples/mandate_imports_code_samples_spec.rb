...
describe 'MandateImports Code Samples' do
  let(:client) do
  ...
  describe '#create code sample' do
    before do
      ...
      stub_url = '/mandate_imports'.gsub(/:\w+/, '[^/]+')
      stub_request(:post, /.*api.gocardless.com#{stub_url}/).
        to_return(
          body: { 'mandate_imports' => {} }.to_json,
  ...
  describe '#get code sample' do
    before do
      # Convert :param placeholders to regex wildcards for flexible matching
      stub_url = '/mandate_imports/:identity'.gsub(/:\w+/, '[^/]+')
  ...
  describe '#submit code sample' do
    before do
      # Convert :param placeholders to regex wildcards for flexible matching
      stub_url = '/mandate_imports/:identity/actions/submit'.gsub(/:\w+/, '[^/]+')
      stub_request(:post, /.*api.gocardless.com#{stub_url}/).
        to_return(
          body: { 'mandate_imports' => {} }.to_json,
          headers: response_headers
  ...
  describe '#cancel code sample' do
    before do
      # Convert :param placeholders to regex wildcards for flexible matching
      stub_url = '/mandate_imports/:identity/actions/cancel'.gsub(/:\w+/, '[^/]+')
      stub_request(:post, /.*api.gocardless.com#{stub_url}/).
        to_return(
          body: { 'mandate_imports' => {} }.to_json,
          headers: response_headers
