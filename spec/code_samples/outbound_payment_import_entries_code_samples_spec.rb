...
describe 'OutboundPaymentImportEntries Code Samples' do
  let(:client) do
  ...
  describe '#list code sample' do
    before do
      ...
      stub_url = '/outbound_payment_import_entries'.gsub(/:\w+/, '[^/]+')
      stub_request(:get, /.*api.gocardless.com#{stub_url}/).
        to_return(
          body: { 'outbound_payment_import_entries' => [{}], 'meta' => { 'cursors' => {}, 'limit' => 50 } }.to_json,
